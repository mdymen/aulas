                ...
                <ul class="nav sidebar-menu">
                    ...
                    <li>
                        <a href="<?php echo $this->baseUrl() . "/curso"; ?>">
                            ...
                            <span class="menu-text"> Admin - Cursos </span>
                        </a>
                    </li>
                    <!--Widgets-->
                    <li>
                        <a href="<?php echo $this->baseUrl(). "/curso/adicionar"; ?>">
                            ...
                            <span class="menu-text">Admin - Adicionar curso </span>
                        </a>
                    </li>
                    <!--UI Elements-->
                    <li>
                        <a href="<?php echo $this->baseUrl(). "/slide/adicionar"; ?>">
                            ...
                            <span class="menu-text">Admin - Adicionar slide </span>
                        </a>    
                    </li>
                     <li>
                        <a href="<?php echo $this->baseUrl(). "/pergunta/index"; ?>">
                            <i class="menu-icon fa fa-desktop"></i>
                            <span class="menu-text">Admin - Perguntas </span>
                        </a>    
                    </li>                 
                    <!--Right to Left-->
